...
export const TAG_GLYPHS = {
  ...
  // ── Projects added from the evidence report (MTG engine, lagd, FOG dashboard, AWS labs, games, local AI) ──
  ...
  cloudformation: 'cloud-cog',
  'aws cdk': 'braces',
  'aws cli': 'terminal',
  'infrastructure as code': 'braces',
  iam: 'key-round',
  'cloud cost control': 'shield-check',
  etw: 'scroll-text',
  'windows apis': 'windows',
  'windows internals': 'windows',
  'performance diagnostics': 'gauge',
  benchmarking: 'gauge',
  'gpu troubleshooting': 'stethoscope',
  debugging: 'stethoscope',
  testing: 'list-checks',
